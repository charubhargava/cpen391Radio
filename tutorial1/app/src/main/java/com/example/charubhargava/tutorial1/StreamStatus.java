...
public class StreamStatus {
    ...
    //Overloaded update stream status for changing stream/play/pause
    public void updateStreamStatus(final String streamId, final boolean isPlaying){
        ...
        try {
            ...
            streamStatusJSON.put(CURRENT_VOLUME_KEY, curVol);
    ...
    //Overloaded update stream status for updating data (GET)
